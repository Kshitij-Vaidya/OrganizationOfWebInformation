...
The nearest neighbours for the words "data", "cities" and "temperature" in the GloVe embeddings with dimension 200 have been mentioned below along with the results of task 2.
...
We see that the TF-IDF embeddings perform marginally better than raw SVD. 
